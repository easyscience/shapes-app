...
EaElements.GroupColumn {
    ...
    Column {
        ...
        EaElements.ComboBox {
            ...
            Component.onCompleted: currentIndex = model.indexOf(Globals.BackendWrapper.ballStructure.fill)
            onActivated: (i) => Globals.BackendWrapper.ballStructure.fill = model[i]
        }
    }
